...
- `grade` gates content: `trivial` parts get role + how only; `routine` adds impact + fail; `consequential` adds the tradeoff block. Grading measures product consequence, not code complexity.
